...
public class Screen3Controller implements Initializable, ControlledScreen {
    ...
    @FXML
    private void clearScore(ActionEvent event) throws IOException {
        ...
        highScoreLabel.setText(finalString);
        yourScore.setText("Your Last Score: " + (String) jsonMap.get("lastGameScore"));
    }
}
